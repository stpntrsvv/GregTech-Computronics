package com.gregtechcomputronics;
...
@Mod(ComputronicsMod.MOD_ID)
@SuppressWarnings("removal")
public class ComputronicsMod {

    public static final String MOD_ID = "gtcomputronics";
    public static final Logger LOGGER = LogManager.getLogger();
    public static GTRegistrate REGISTRATE = GTRegistrate.create(ComputronicsMod.MOD_ID);

    public ComputronicsMod() {
    ...
    private void addMaterialRegistries(MaterialRegistryEvent event) {
        GTCEuAPI.materialManager.createRegistry(ComputronicsMod.MOD_ID);
    }
